...
{
    const char* pszTimestamp = "JDCOIN Genesis Block: 2020/12/14 01:30:00";
    const CScript genesisOutputScript = CScript() << ParseHex("7c5a4e83b2703ccf322f7dbd62dd5855ac7c10bd055814ce121ba32607d573b8810c02c0582aed05b4deb9c4b77b26d92428c61256cd42774babea0a073b2ed0c9") << OP_CHECKSIG;
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256S("0x")); //!< JDCOIN v4.1.1 enforced
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1608232324, 0, 0x1e0ffff0, 1, 250 * COIN);
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "52.15.203.131", true));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "52.15.203.131", true));    // Secondary DNS Seeder from Fuzzbawls
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "jdcoin-testnet.seed.fuzzbawls.pw", true));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "jdcoin-testnet.seed2.fuzzbawls.pw", true));
